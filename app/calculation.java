        ...
        buttonCalculate.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        String payableZakat = totalAmount >= 75000 ? String.format("Payable Zakat: %s BDT", calculatedZakat) : "Zakat is not applicable ot your finances.";
